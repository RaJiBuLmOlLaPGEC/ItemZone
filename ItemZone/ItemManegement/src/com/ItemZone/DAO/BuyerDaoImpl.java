...
public class BuyerDaoImpl implements BuyerDao{
	...
	public List<ProductSeller> showProduct(String ct) throws ProductException {
		List<ProductSeller> allproducts=new LinkedList<>();
		try(Connection conn=DBUtil.provideConnection()) {
...
//						System.out.println("Complete Step 2 and enter step 3");
						...
						if(x>0) {
//							System.out.println("step3 complete enter stem4");
				...
				status= "there is no such product id";
			}
